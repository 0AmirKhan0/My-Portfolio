...
export default function Profile({}) {
  return (
    <div className="flex items-center gap-x-2 transition-colors duration-75 text-primary-foreground">
      {/* Photo */}
      <div className="relative w-[100px] h-[100px] flex rounded-full items-center justify-center bg-gradient-to-r from-blue-joust to-green-benzol">
        <Image
          src={MyImage}
          alt="AMir Khan photo"
      ...
      <div className="text-3xl font-medium">Amir Khan</div>
    </div>
  );
}
